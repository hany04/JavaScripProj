...
<html lang="fr">
    ...
    <body>
		<div class="logo"><img src="..images\products\logoastro (2).png" alt="Logo"> </div>
		...
		if(isset($_POST['insert'])){
			...
			?>
				<div class="form">
					...
					<a href="#" class="btn btnMenu" onclick="window.location='../html/login.html'">Se connecter sur le site</a>
